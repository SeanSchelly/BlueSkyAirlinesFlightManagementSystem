...
public class MainApp {
    public static void main(String[]args) {
        ...
        EconomyClassPassenger Passenger1 = new EconomyClassPassenger("Sean", 19);
        Passenger1.register();
        ...
        switch(choiceAircraft) {
            case 1:
                System.out.println("Your choice("+aircraft1.make+")"+" has been logged.");
                break;
            case 2:
                System.out.println("Your choice("+aircraft2.make+")"+" has been logged.");
                break;
            case 3:
                System.out.println("Your choice("+aircraft3.make+")"+" has been logged.");
                break;
            default:
